...
#change success column to success and no-collision
...
# grouped_df['density_index_log'] = grouped_df['density_index'] #
# grouped_df['clutter_index_log'] = grouped_df['clutter_index']#np.log(grouped_df['clutter_index'] + epsilon)
# grouped_df['structure_index_log'] = grouped_df['structure_index']#np.log(grouped_df['structure_index'] + epsilon)
...
sc = ax.scatter(density_index_log, clutter_index_log, structure_index_log, c=success_rate_percentage, cmap='RdYlGn', s=10)
